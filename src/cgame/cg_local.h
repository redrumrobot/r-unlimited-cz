...
typedef struct
{
  ...
  //rotaxfun
  qhandle_t   chatBubblle;
  qhandle_t   chatBubblle_h;
  qhandle_t   chatBubblle_a;
  ...
  //ROTAXfun
  qhandle_t   humanReactorDestroyedPS;
  qhandle_t   humanTelenodeDestroyedPS;
  qhandle_t   humanTurretDestroyedPS;
  qhandle_t   humanTeslaDestroyedPS;
  qhandle_t   humanDcDestroyedPS;
  qhandle_t   humanMedistationDestroyedPS;
  qhandle_t   humanRepeaterDestroyedPS;
  qhandle_t   humanPlankDestroyedPS;
  qhandle_t   humanCrateDestroyedPS;
  qhandle_t   humanPillarDestroyedPS;
  qhandle_t   humanBrickhDestroyedPS;
  qhandle_t   humanContainerDestroyedPS;
  qhandle_t   humanFlaghDestroyedPS;
  
  //qhandle_t   humanPoisonedPS;
  
  qhandle_t   alienBushDestroyedPS;
  qhandle_t   alienOvermindDestroyedPS;
  qhandle_t   alienEggDestroyedPS;
  qhandle_t   alienBarricadeDestroyedPS;
  qhandle_t   alienAcidtubeDestroyedPS;
  qhandle_t   alienTrapperDestroyedPS;
  qhandle_t   alienBoosterDestroyedPS;
  qhandle_t   alienHiveDestroyedPS;
  //qhandle_t   alienHovelDestroyedPS;
  qhandle_t   alienBambooDestroyedPS;
  qhandle_t   alienBrickaDestroyedPS;
  qhandle_t   alienBridgeDestroyedPS;
  qhandle_t   alienRockDestroyedPS;
  qhandle_t   alienFlowerDestroyedPS;
  qhandle_t   alienGrassDestroyedPS;
  qhandle_t   alienFlagaDestroyedPS;
  qhandle_t   alienJumppadDestroyedPS;
...
//rotaxfun
extern  vmCvar_t    cg_drawBubblle;
extern  vmCvar_t    cg_BubblleZoom;
