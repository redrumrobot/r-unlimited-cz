...
//rotaxfun
vmCvar_t  cg_drawBubblle;
vmCvar_t  cg_BubblleZoom;
...
static cvarTable_t cvarTable[ ] =
{
  ...
  //rotaxfun
  { &cg_drawBubblle, "cg_drawBubblle", "1", CVAR_ARCHIVE|CVAR_USERINFO },
  { &cg_BubblleZoom, "cg_BubblleZoom", "1", CVAR_ARCHIVE|CVAR_USERINFO },
...
static void CG_RegisterGraphics( void )
{
  ...
  //rotaxfun
  cgs.media.chatBubblle                = trap_R_RegisterShader( "gfx/sprites/chatbubblle" );
  cgs.media.chatBubblle_h              = trap_R_RegisterShader( "gfx/sprites/chatbubblle_h" );
  ...
  //ROTAXfun
  cgs.media.alienOvermindDestroyedPS = CG_RegisterParticleSystem( "alienOvermindDestroyedPS" );
  cgs.media.alienBushDestroyedPS = CG_RegisterParticleSystem( "alienBushDestroyedPS" );
  cgs.media.alienEggDestroyedPS = CG_RegisterParticleSystem( "alienEggDestroyedPS" );
  cgs.media.alienBarricadeDestroyedPS = CG_RegisterParticleSystem( "alienBarricadeDestroyedPS" );
  cgs.media.alienAcidtubeDestroyedPS = CG_RegisterParticleSystem( "alienAcidtubeDestroyedPS" );
  cgs.media.alienTrapperDestroyedPS = CG_RegisterParticleSystem( "alienTrapperDestroyedPS" );
  cgs.media.alienBoosterDestroyedPS = CG_RegisterParticleSystem( "alienBoosterDestroyedPS" );
  cgs.media.alienHiveDestroyedPS = CG_RegisterParticleSystem( "alienHiveDestroyedPS" );
  //cgs.media.alienHovelDestroyedPS = CG_RegisterParticleSystem( "alienHovelDestroyedPS" );
  cgs.media.alienBambooDestroyedPS = CG_RegisterParticleSystem( "alienBambooDestroyedPS" );
  cgs.media.alienBrickaDestroyedPS = CG_RegisterParticleSystem( "alienBrickaDestroyedPS" );
  cgs.media.alienBridgeDestroyedPS = CG_RegisterParticleSystem( "alienBridgeDestroyedPS" );
  cgs.media.alienRockDestroyedPS = CG_RegisterParticleSystem( "alienRockDestroyedPS" );
  cgs.media.alienFlowerDestroyedPS = CG_RegisterParticleSystem( "alienFlowerDestroyedPS" );
  cgs.media.alienGrassDestroyedPS = CG_RegisterParticleSystem( "alienGrassDestroyedPS" );
  cgs.media.alienFlagaDestroyedPS = CG_RegisterParticleSystem( "alienFlagaDestroyedPS" );
  cgs.media.alienJumppadDestroyedPS = CG_RegisterParticleSystem( "alienJumppadDestroyedPS" );

  cgs.media.humanReactorDestroyedPS = CG_RegisterParticleSystem( "humanReactorDestroyedPS" );
  cgs.media.humanTelenodeDestroyedPS = CG_RegisterParticleSystem( "humanTelenodeDestroyedPS" );
  cgs.media.humanTurretDestroyedPS = CG_RegisterParticleSystem( "humanTurretDestroyedPS" );
  cgs.media.humanTeslaDestroyedPS = CG_RegisterParticleSystem( "humanTeslaDestroyedPS" );
  cgs.media.humanDcDestroyedPS = CG_RegisterParticleSystem( "humanDcDestroyedPS" );
  cgs.media.humanMedistationDestroyedPS = CG_RegisterParticleSystem( "humanMedistationDestroyedPS" );
  cgs.media.humanRepeaterDestroyedPS = CG_RegisterParticleSystem( "humanRepeaterDestroyedPS" );
  cgs.media.humanPlankDestroyedPS = CG_RegisterParticleSystem( "humanPlankDestroyedPS" );
  cgs.media.humanCrateDestroyedPS = CG_RegisterParticleSystem( "humanCrateDestroyedPS" );
  cgs.media.humanPillarDestroyedPS = CG_RegisterParticleSystem( "humanPillarDestroyedPS" );
  cgs.media.humanBrickhDestroyedPS = CG_RegisterParticleSystem( "humanBrickhDestroyedPS" );
  cgs.media.humanContainerDestroyedPS = CG_RegisterParticleSystem( "humanContainerDestroyedPS" );
  cgs.media.humanFlaghDestroyedPS = CG_RegisterParticleSystem( "humanFlaghDestroyedPS" );
  
  //cgs.media.humanPoisonedPS = CG_RegisterParticleSystem( "humanPoisonedPS" );
