...
===================
*/
void CG_AlienBuildableExplosion( vec3_t origin, vec3_t dir, int buildable )//ROTAXfun int buildable
{
  particleSystem_t  *ps;
  ...
  //particle system
  if (buildable == BA_A_OVERMIND)//ROTAXfun
    ps = CG_SpawnNewParticleSystem( cgs.media.alienOvermindDestroyedPS );
  else if (buildable == BA_A_SPAWN)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienEggDestroyedPS );
  else if (buildable == BA_A_BARRICADE)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienBarricadeDestroyedPS );
  else if (buildable == BA_A_ACIDTUBE)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienAcidtubeDestroyedPS );
  else if (buildable == BA_A_TRAPPER)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienTrapperDestroyedPS );
  else if (buildable == BA_A_BOOSTER)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienBoosterDestroyedPS );
  else if (buildable == BA_A_HIVE)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienHiveDestroyedPS );
  else if (buildable == BA_A_BAMBOO)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienBambooDestroyedPS );
  else if (buildable == BA_A_BRICKA)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienBrickaDestroyedPS );
  else if (buildable == BA_A_BRIDGE)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienBridgeDestroyedPS );
  else if (buildable == BA_A_ROCK)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienRockDestroyedPS );
  //bush ma vlastni funkci
  else if (buildable == BA_A_FLOWER)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienFlowerDestroyedPS );
  else if (buildable == BA_A_GRASS)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienGrassDestroyedPS );
  else if (buildable == BA_A_FLAGA)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienFlagaDestroyedPS );
  else if (buildable == BA_A_JUMPPAD)
    ps = CG_SpawnNewParticleSystem( cgs.media.alienJumppadDestroyedPS );
  else
...
/*
===================
CG_AlienBushExplosion

Generated a bunch of gibs launching out from a location
===================
*/
void CG_AlienBushExplosion( vec3_t origin, vec3_t dir )
{
  particleSystem_t  *ps;
  ...
  //particle system
  ps = CG_SpawnNewParticleSystem( cgs.media.alienBushDestroyedPS );
...
=================
*/
void CG_HumanBuildableExplosion( vec3_t origin, vec3_t dir, int buildable )//ROTAXfun int buildable
{
  particleSystem_t  *ps;
  ...
  //particle system
  if (buildable == BA_H_REACTOR)//ROTAXfun
    ps = CG_SpawnNewParticleSystem( cgs.media.humanReactorDestroyedPS );
  else if (buildable == BA_H_SPAWN)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanTelenodeDestroyedPS );
  else if (buildable == BA_H_MGTURRET)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanTurretDestroyedPS );
  else if (buildable == BA_H_TESLAGEN)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanTeslaDestroyedPS );
  //armoury chybi
  else if (buildable == BA_H_DCC)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanDcDestroyedPS );
  else if (buildable == BA_H_MEDISTAT)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanMedistationDestroyedPS );
  else if (buildable == BA_H_REPEATER)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanRepeaterDestroyedPS );
  else if (buildable == BA_H_PLANK)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanPlankDestroyedPS );
  else if (buildable == BA_H_CRATE)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanCrateDestroyedPS );
  else if (buildable == BA_H_PILLAR)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanPillarDestroyedPS );
  else if (buildable == BA_H_BRICKH)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanBrickhDestroyedPS );
  else if (buildable == BA_H_CONTAINER)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanContainerDestroyedPS );
  else if (buildable == BA_H_FLAGH)
    ps = CG_SpawnNewParticleSystem( cgs.media.humanFlaghDestroyedPS );
  else
                                              ...
                                              vec3_t outAxis[ 3 ], vec3_t outOrigin )
{
  ...
  CG_CapTrace( &tr, start, mins, maxs, end, skipNumber,
               MASK_PLAYERSOLID );//ROTAXfun CONTENTS_SOLID | CONTENTS_PLAYERCLIP
