...
gentity_t *launch_mine( gentity_t *self, vec3_t start, vec3_t dir );//ROTAXfun
gentity_t *launch_flare( gentity_t *self, vec3_t start, vec3_t dir );//ROTAXfun
gentity_t *fire_acidBomb( gentity_t *self, vec3_t start, vec3_t dir, int wp );//ROTAXfun
