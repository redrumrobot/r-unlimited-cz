...
static const buildableAttributes_t bg_buildableList[ ] =
{
  ...
  },
  {
    ...
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
    0.0f,                 //float     minNormal;//ROTAXfun
    qtrue,                //qboolean  invertNormal;//ROTAXfun
    qfalse,                //qboolean  creepTest;
  ...
  },
  {
    ...
    qtrue,                //qboolean  invertNormal;//ROTAX
  ...
  {//ROTAX
    BA_H_PLANK,          //int       buildNum;
    "plank",                 //char      *buildName;
    "Plank",             //char      *humanName;
    "Used to make better base",
    "team_human_plank",  //char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    PLANK_BP,            //int       buildPoints;
    ( 1 << S2 )|( 1 << S3 ), //int  stages
    PLANK_HEALTH,        //int       health;
    0,                     //int       regenRate;
    PLANK_SPLASHDAMAGE, //int       splashDamage;
    PLANK_SPLASHRADIUS, //int       splashRadius;
    MOD_HSPAWN,            //int       meansOfDeath;
    TEAM_HUMANS,            //int       team;
    ( 1 << WP_HBUILD ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    300,                   //int       nextthink;
    PLANK_BT,            //int       buildTime;
    qfalse,                 //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
  ...
  {
    BA_H_CRATE,         //int       buildNum;
    "crate",            //char      *buildName;
    "Crate",   //char      *humanName;
    "Used to make better base",
    "team_human_crate", //char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    CRATE_BP,           //int       buildPoints;
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ), //int  stages
    CRATE_HEALTH,       //int       health;
    0,                     //int       regenRate;
    CRATE_SPLASHDAMAGE, //int       splashDamage;
    CRATE_SPLASHRADIUS, //int       splashRadius;
    MOD_HSPAWN,            //int       meansOfDeath;
    TEAM_HUMANS,            //int       team;
    ( 1 << WP_HBUILD ),   //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    300,                    //int       nextthink;
    CRATE_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,        //int       turretRange;
    0,       //int       turretFireSpeed;
    WP_NONE,           //weapon_t  turretProjType;
  ...
  {
    BA_H_PILLAR,         //int       buildNum;
    "pillar",            //char      *buildName;
    "Pillar",   //char      *humanName;
    "Used to make better base",
    "team_human_pillar", //char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    PILLAR_BP,           //int       buildPoints;
    ( 1 << S3 ), //int  stages
    CRATE_HEALTH,       //int       health;
    0,                     //int       regenRate;
    PILLAR_SPLASHDAMAGE, //int       splashDamage;
    PILLAR_SPLASHRADIUS, //int       splashRadius;
    MOD_HSPAWN,            //int       meansOfDeath;
    TEAM_HUMANS,            //int       team;
    ( 1 << WP_HBUILD ),   //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    300,                    //int       nextthink;
    PILLAR_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,        //int       turretRange;
    0,       //int       turretFireSpeed;
    WP_NONE,           //weapon_t  turretProjType;
    0.95f,                 //float     minNormal; rotax
    qtrue,                //qboolean  invertNormal; rotax
    qfalse,                //qboolean  creepTest;
    0,                     //int       creepSize;
    qfalse,                //qboolean  dccTest;
  ...
  {
    BA_H_BRICKH,         //int       buildNum;
    "brickh",            //char      *buildName;
    "Brick",   //char      *humanName;
    "Used to make better base",
    "team_human_brick", //char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    BRICKH_BP,           //int       buildPoints;
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ), //int  stages
    BRICKH_HEALTH,       //int       health;
    0,                     //int       regenRate;
    BRICKH_SPLASHDAMAGE, //int       splashDamage;
    BRICKH_SPLASHRADIUS, //int       splashRadius;
    MOD_HSPAWN,            //int       meansOfDeath;
    TEAM_HUMANS,            //int       team;
    ( 1 << WP_HBUILD ),   //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    300,                    //int       nextthink;
    BRICKH_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,        //int       turretRange;
    0,       //int       turretFireSpeed;
    WP_NONE,           //weapon_t  turretProjType;
  ...
  {
    BA_H_CONTAINER,         //int       buildNum;
    "container",            //char      *buildName;
    "Container",   //char      *humanName;
    "Used to make strong wall for outside base",
    "team_human_container", //char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    CONTAINER_BP,           //int       buildPoints;
    ( 1 << S3 ), //int  stages
    CONTAINER_HEALTH,       //int       health;
    0,                     //int       regenRate;
    CONTAINER_SPLASHDAMAGE, //int       splashDamage;
    CONTAINER_SPLASHRADIUS, //int       splashRadius;
    MOD_HSPAWN,            //int       meansOfDeath;
    TEAM_HUMANS,            //int       team;
    ( 1 << WP_HBUILD ),   //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    300,                    //int       nextthink;
    CONTAINER_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,        //int       turretRange;
    0,       //int       turretFireSpeed;
    WP_NONE,           //weapon_t  turretProjType;
  ...
  {
    BA_H_FLAGH,         //int       buildNum;
    "flagh",            //char      *buildName;
    "Flag",   //char      *humanName;
    "Used to provoke other team",
    "team_human_flag", //char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    FLAGH_BP,           //int       buildPoints;
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ), //int  stages
    FLAGH_HEALTH,       //int       health;
    0,                     //int       regenRate;
    FLAGH_SPLASHDAMAGE, //int       splashDamage;
    FLAGH_SPLASHRADIUS, //int       splashRadius;
    MOD_HSPAWN,            //int       meansOfDeath;
    TEAM_HUMANS,            //int       team;
    ( 1 << WP_HBUILD ),   //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    300,                    //int       nextthink;
    FLAGH_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,        //int       turretRange;
    0,       //int       turretFireSpeed;
    WP_NONE,           //weapon_t  turretProjType;
  ...
  {
    BA_A_BRICKA,         //int       buildNum;
    "bricka",           //char      *buildName;
    "Brick",           //char      *humanName;
    "Used to make better base",
    "team_alien_brick",//char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    BRICKA_BP,           //int       buildPoints;
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ), //int  stages
    BRICKA_HEALTH,       //int       health;
    BRICKA_REGEN,        //int       regenRate;
    BRICKA_SPLASHDAMAGE, //int       splashDamage;
    BRICKA_SPLASHRADIUS, //int       splashRadius;
    MOD_ASPAWN,             //int       meansOfDeath;
    TEAM_ALIENS,            //int       team;
    ( 1 << WP_ABUILD )|( 1 << WP_ABUILD2 ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    200,                   //int       nextthink;
    BRICKA_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
    ...
    qtrue,                 //qboolean  invertNormal;
    qtrue,                 //qboolean  creepTest;
    BRICKA_CREEPSIZE,    //int       creepSize;
    qfalse,                //qboolean  dccTest;
    qfalse,                //qboolean  transparentTest;
    qfalse,                //qboolean  reactorTest;
    qfalse,                //qboolean  replacable;
  ...
  {
    BA_A_BRIDGE,         //int       buildNum;
    "bridge",           //char      *buildName;
    "Bridge",           //char      *humanName;
    "Used to make better base",
    "team_alien_bridge",//char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    BRIDGE_BP,           //int       buildPoints;
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ), //int  stages
    BRIDGE_HEALTH,       //int       health;
    BRIDGE_REGEN,        //int       regenRate;
    BRIDGE_SPLASHDAMAGE, //int       splashDamage;
    BRIDGE_SPLASHRADIUS, //int       splashRadius;
    MOD_ASPAWN,             //int       meansOfDeath;
    TEAM_ALIENS,            //int       team;
    ( 1 << WP_ABUILD )|( 1 << WP_ABUILD2 ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    200,                   //int       nextthink;
    BRIDGE_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
    ...
    qtrue,                 //qboolean  invertNormal;
    qtrue,                 //qboolean  creepTest;
    BRIDGE_CREEPSIZE,    //int       creepSize;
    qfalse,                //qboolean  dccTest;
    qfalse,                //qboolean  transparentTest;
    qfalse,                //qboolean  reactorTest;
    qfalse,                //qboolean  replacable;
  ...
  {
    BA_A_BAMBOO,         //int       buildNum;
    "bamboo",           //char      *buildName;
    "Bamboo",           //char      *humanName;
    "Used to make better base. "
      "Reflecting shots from Pulse Rifle and Lucifer Cannon.",
    "team_alien_bamboo",//char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    BAMBOO_BP,           //int       buildPoints;
    ( 1 << S2 )|( 1 << S3 ), //int  stages
    BAMBOO_HEALTH,       //int       health;
    BAMBOO_REGEN,        //int       regenRate;
    BAMBOO_SPLASHDAMAGE, //int       splashDamage;
    BAMBOO_SPLASHRADIUS, //int       splashRadius;
    MOD_ASPAWN,             //int       meansOfDeath;
    TEAM_ALIENS,            //int       team;
    ( 1 << WP_ABUILD )|( 1 << WP_ABUILD2 ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    200,                   //int       nextthink;
    BAMBOO_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
    ...
    qtrue,                 //qboolean  invertNormal;
    qtrue,                 //qboolean  creepTest;
    BAMBOO_CREEPSIZE,    //int       creepSize;
    qfalse,                //qboolean  dccTest;
    qfalse,                //qboolean  transparentTest;
    qfalse,                //qboolean  reactorTest;
    qfalse,                //qboolean  replacable;
  ...
  {
    BA_A_ROCK,         //int       buildNum;
    "rock",           //char      *buildName;
    "Rock",           //char      *humanName;
    "Used to make better base",
    "team_alien_rock",//char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    ROCK_BP,           //int       buildPoints;
    ( 1 << S3 ), //int  stages
    ROCK_HEALTH,       //int       health;
    ROCK_REGEN,        //int       regenRate;
    ROCK_SPLASHDAMAGE, //int       splashDamage;
    ROCK_SPLASHRADIUS, //int       splashRadius;
    MOD_ASPAWN,             //int       meansOfDeath;
    TEAM_ALIENS,            //int       team;
    ( 1 << WP_ABUILD )|( 1 << WP_ABUILD2 ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    200,                   //int       nextthink;
    ROCK_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
  ...
  {
    BA_A_BUSH,         //int       buildNum;
    "bush",           //char      *buildName;
    "Bush",           //char      *humanName;
    "Used to camouflage base and small aliens can hide inside. "
      "When is destroyed, nearby humans are poisoned.",
    "team_alien_bush",//char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    BUSH_BP,           //int       buildPoints;
    ( 1 << S2 )|( 1 << S3 ), //int  stages
    BUSH_HEALTH,       //int       health;
    BUSH_REGEN,        //int       regenRate;
    BUSH_SPLASHDAMAGE, //int       splashDamage;
    BUSH_SPLASHRADIUS, //int       splashRadius;
    MOD_BUSH,             //int       meansOfDeath;
    TEAM_ALIENS,            //int       team;
    ( 1 << WP_ABUILD )|( 1 << WP_ABUILD2 ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    200,                   //int       nextthink;
    BUSH_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
  ...
  {
    BA_A_FLOWER,         //int       buildNum;
    "flower",           //char      *buildName;
    "Flower",           //char      *humanName;
    "Used to make better base design or for Granger female",
    "team_alien_flower",//char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    FLOWER_BP,           //int       buildPoints;
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ), //int  stages
    FLOWER_HEALTH,       //int       health;
    FLOWER_REGEN,        //int       regenRate;
    FLOWER_SPLASHDAMAGE, //int       splashDamage;
    FLOWER_SPLASHRADIUS, //int       splashRadius;
    MOD_ASPAWN,             //int       meansOfDeath;
    TEAM_ALIENS,            //int       team;
    ( 1 << WP_ABUILD )|( 1 << WP_ABUILD2 ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    200,                   //int       nextthink;
    FLOWER_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
    ...
    qtrue,                 //qboolean  invertNormal;
    qtrue,                 //qboolean  creepTest;
    FLOWER_CREEPSIZE,    //int       creepSize;
    qfalse,                //qboolean  dccTest;
    qfalse,                //qboolean  transparentTest;
    qfalse,                //qboolean  reactorTest;
    qfalse,                //qboolean  replacable;
  ...
  {
    BA_A_GRASS,         //int       buildNum;
    "grass",           //char      *buildName;
    "Grass",           //char      *humanName;
    "Used to camouflage base, it's hard to hit it",
    "team_alien_grass",//char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    GRASS_BP,           //int       buildPoints;
    ( 1 << S3 ), //int  stages
    GRASS_HEALTH,       //int       health;
    GRASS_REGEN,        //int       regenRate;
    GRASS_SPLASHDAMAGE, //int       splashDamage;
    GRASS_SPLASHRADIUS, //int       splashRadius;
    MOD_ASPAWN,             //int       meansOfDeath;
    TEAM_ALIENS,            //int       team;
    ( 1 << WP_ABUILD )|( 1 << WP_ABUILD2 ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    200,                   //int       nextthink;
    GRASS_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
  ...
  {
    BA_A_TREE,         //int       buildNum;
    "tree",           //char      *buildName;
    "Tree",           //char      *humanName;
    "Massive tree.",
    "team_alien_tree",//char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    TREE_BP,           //int       buildPoints;
    ( 1 << S2 )|( 1 << S3 ), //int  stages
    TREE_HEALTH,       //int       health;
    TREE_REGEN,        //int       regenRate;
    TREE_SPLASHDAMAGE, //int       splashDamage;
    TREE_SPLASHRADIUS, //int       splashRadius;
    MOD_ASPAWN,             //int       meansOfDeath;
    TEAM_ALIENS,            //int       team;
    ( 1 << WP_ABUILD )|( 1 << WP_ABUILD2 ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    200,                   //int       nextthink;
    TREE_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
  ...
  {
    BA_A_FLAGA,         //int       buildNum;
    "flaga",           //char      *buildName;
    "Flag",           //char      *humanName;
    "Used to provoke other team", 
    "team_alien_flag",//char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    FLAGA_BP,           //int       buildPoints;
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ), //int  stages
    FLAGA_HEALTH,       //int       health;
    FLAGA_REGEN,        //int       regenRate;
    FLAGA_SPLASHDAMAGE, //int       splashDamage;
    FLAGA_SPLASHRADIUS, //int       splashRadius;
    MOD_ASPAWN,             //int       meansOfDeath;
    TEAM_ALIENS,            //int       team;
    ( 1 << WP_ABUILD )|( 1 << WP_ABUILD2 ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    300,                   //int       nextthink;
    FLAGA_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
  ...
  {
    BA_A_JUMPPAD,         //int       buildNum;
    "jumppad",           //char      *buildName;
    "Jump pad",           //char      *humanName;
    "Used to jump higher",
    "team_alien_jumppad",//char      *entityName;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
    JUMPPAD_BP,           //int       buildPoints;
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ), //int  stages
    JUMPPAD_HEALTH,       //int       health;
    JUMPPAD_REGEN,        //int       regenRate;
    JUMPPAD_SPLASHDAMAGE, //int       splashDamage;
    JUMPPAD_SPLASHRADIUS, //int       splashRadius;
    MOD_ASPAWN,             //int       meansOfDeath;
    TEAM_ALIENS,            //int       team;
    ( 1 << WP_ABUILD )|( 1 << WP_ABUILD2 ),    //weapon_t  buildWeapon;
    BANIM_IDLE1,           //int       idleAnim;
    200,                   //int       nextthink;
    JUMPPAD_BT,           //int       buildTime;
    qfalse,                //qboolean  usable;
    0,                     //int       turretRange;
    0,                     //int       turretFireSpeed;
    WP_NONE,               //weapon_t  turretProjType;
    ...
    qtrue,                 //qboolean  invertNormal;
    qtrue,                 //qboolean  creepTest;
    JUMPPAD_CREEPSIZE,    //int       creepSize;
    qfalse,                //qboolean  dccTest;
    qfalse,                //qboolean  transparentTest;
    qfalse,                //qboolean  reactorTest;
    qfalse,                //qboolean  replacable;
...
{
  {
    ...
    0,                                              //int     cost;
    0,                                               //int     value;
    15.f,                                            //float   spriteOffset;//ROTAXfun
  },
  {
    ...
    20.f,                                            //float   spriteOffset;//ROTAXfun
  },
  {
  ...
  },
  {
    ...
    18.f,                                            //float   spriteOffset;//ROTAXfun
  },
  {
  ...
  },
  {
    ...
    22.f,                                            //float   spriteOffset;//ROTAXfun
  },
  {
    ...
    24.f,                                            //float   spriteOffset;//ROTAXfun
  },
  {
    ...
    45.f,                                           //float   spriteOffset;//ROTAXfun
  },
  {
    ...
    53.f,                                            //float   spriteOffset;//ROTAXfun
  },
  {
    ...
    108.f,                                           //float   spriteOffset;//ROTAXfun
  },
  {
    ...
    48.f,                                           //float   spriteOffset;//ROTAXfun
  },
  {
    ...
    0,                                              //int     cost;
    ALIEN_CREDITS_PER_KILL,                          //int     value;
    38.f,                                           //float   spriteOffset;//ROTAXfun
  }
};
...
float BG_FindSpriteHeightForClass( int pclass ) {
  ...
  for( i = 0; i < bg_numClasses; i++ )
  {
    ...
    {
      return bg_classList[ i ].spriteOffset;
    }
  }
  return 0.f;
}
...
static const weaponAttributes_t bg_weapons[ ] =
{
  ...
  {//ROTAXfun
    WP_FLARE,         //int       weaponNum;
    FLARE_PRICE,        //int       price;
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ), //int  stages
    SLOT_NONE,            //int       slots;
    "flare",            //char      *weaponName;
    "Flare",            //char      *weaponHumanName;
    "",
    1,                    //int       maxAmmo;
    0,                    //int       maxClips;
    qfalse,               //int       infiniteAmmo;
    qfalse,               //int       usesEnergy;
    FLARE_REPEAT,       //int       repeatRate1;
    0,                    //int       repeatRate2;
    0,                    //int       repeatRate3;
    0,                    //int       reloadTime;
...
static const upgradeAttributes_t bg_upgrades[ ] =
{
  ...
  {//ROTAXfun
    UP_FLARE,             //int   upgradeNum;
    FLARE_PRICE,          //int   price;
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ),//int  stages
    SLOT_NONE,              //int   slots;
    "fla",                 //char  *upgradeName;
    "Flare",              //char  *upgradeHumanName;
    "",
    0,
    qtrue,                  //qboolean purchasable
    qtrue,                  //qboolean usable
